...
def llm_capabilities(cfg: ZabctlConfig) -> None:
    ...
    payload = {
        ...
        "commands": [
            ...
            {
                "name": "enable host <id|name>",
                "description": "Enable monitoring for a host (sets status=0)",
                "flags": [],
                "output_formats": ["table", "json", "jsonl", "yaml", "wide"],
                "pipeable": False,
                "stdin_accepts": None,
            ...
            {
                "name": "disable host <id|name>",
                "description": "Disable monitoring for a host (sets status=1)",
                "flags": [],
                "output_formats": ["table", "json", "jsonl", "yaml", "wide"],
                "pipeable": False,
                "stdin_accepts": None,
            ...
            {
                "name": "enable trigger <id>",
                "description": "Enable a trigger by numeric id (sets status=0)",
                "flags": [],
                "output_formats": ["table", "json", "jsonl", "yaml", "wide"],
                "pipeable": False,
                "stdin_accepts": None,
            ...
            {
                "name": "disable trigger <id>",
                "description": "Disable a trigger by numeric id (sets status=1)",
                "flags": [],
                "output_formats": ["table", "json", "jsonl", "yaml", "wide"],
                "pipeable": False,
                "stdin_accepts": None,
            ...
            {
                "name": "acknowledge <event-id>",
                "description": "Acknowledge a problem event. Use --close to also close it.",
                "flags": [
                    {"name": "--message", "description": "Acknowledgment message (required)"},
                    {"name": "--close", "description": "Also close the problem (action=ack+close)"},
                ],
                "output_formats": ["table", "json", "jsonl", "yaml", "wide"],
                "pipeable": False,
                "stdin_accepts": None,
            ...
            },
            {
                ...
                "flags": [
                    {"name": "--host", "description": "Host name to include (repeatable)"},
                    {"name": "--start", "description": "Start time (ISO 8601 or Unix epoch)"},
                    {"name": "--duration", "description": "Duration in minutes"},
                    {"name": "--name", "description": "Window name (auto-generated if omitted)"},
                    {"name": "--no-data", "description": "Suppress data collection during maintenance"},
            ...
            {
                "name": "create host",
                "description": "Create a Zabbix host from flags or a YAML file",
                "flags": [
                    {"name": "--from-file", "description": "YAML file describing the host (mutually exclusive with --host)"},
                    {"name": "--host", "description": "Host technical name"},
                    {"name": "--group", "description": "Host group name (repeatable)"},
                    {"name": "--template", "description": "Template name to link (repeatable)"},
                    {"name": "--ip", "description": "Agent interface IP (default: 127.0.0.1)"},
                    {"name": "--port", "description": "Agent interface port (default: 10050)"},
                    {"name": "--yes", "description": "Skip confirmation prompt"},
                ],
                "output_formats": ["table", "json", "jsonl", "yaml", "wide"],
                "pipeable": False,
            ...
            {
                "name": "delete host <id|name>",
                "description": "Delete a host. Prompts for confirmation unless --yes is given.",
                "flags": [
                    {"name": "--yes", "description": "Skip confirmation prompt"},
                ],
                "output_formats": ["table", "json", "jsonl", "yaml", "wide"],
